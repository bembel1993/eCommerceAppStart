        ...
        try {
            ...
            while (totalProduct.next()) {
               ...
               // product_price = totalProduct.getString(4);
                product_selling_price = totalProduct.getString(3);
                ...
                orderProducts = DatabaseConnection.insertUpdateFromSqlQuery(
                        "insert into tblorders(order_no,customer_name,mobile_number,email_id,address,address_type,pincode,product_name,quantity,product_selling_price,product_total_price,order_status,payment_mode,payment_id) values('"
