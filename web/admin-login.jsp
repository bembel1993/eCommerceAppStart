                    ...
                    <div class="col-md-12">
                        <div class="navbar-collapse collapse ">
                            <ul id="menu-top" class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="admin-login.jsp">АВТОРИЗАЦИЯ АДМИНА </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="panel panel-danger">
                            ...
                            <div class="panel-body">
                                ...
                                %>
                                <div class="alert alert-danger" id="danger">Вы ввели неправильные учетные данные.</div>
                                <%
                                    }
                                %>
                                <form action="AdminLogin" method="post">
                                    <div class="form-group">
                                        <label>Электронная почта.:</label> <input type="text" name="email" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Пароль.:</label> <input type="password" name="upass" class="form-control">
                                    </div>
