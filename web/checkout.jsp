    ...
    <div class="container">
        ...
        <div class="top_nav_right">
            <div class="cart box_1">
                ...
                <p>
                    <a href="javascript:;" class="simpleCart_empty">Mоя корзина</a>
                </p>
            </div>
        </div>
    </div>
...
<div class="checkout">
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tr class="rem1">
                ...
                <td class="invert"><a
                        ...
                        onclick="return confirm('Вы действительно хотите удалить товар из корзины?');">
        ...
        <form action="GetProductsOrder" method="post">
            ...
            <div>
                <div class="form-group">
                    <label><font color="black">Ваше имя
                    </font></label> <input type="text" name="name"
                ...
                <div class="form-group">
                    <label><font color="black">
                        Номер телефона</font></label> <input type="text" name="phone"
                ...
                <div class="form-group">
                    <label>
                        <font color="black">
                            Эл. почта
                        </font></label> <input type="text" name="email"
                ...
                <div class="form-group">
                    <label><font color="black">
                        Тип адреса
                    </font></label> <select name="addressType"
                ...
                <div>
                    ...
                    <input type="submit" value="Buy Products" class="btn btn-success"
                           onclick="return confirm('Вы действительно хотите совершить заказ?');">
                </div>
            </div>
        </form>
        <%
        ...
        <center>
            <font color="black">
            <strong>Спасибо за оформленный заказ.</strong>
            </font>
        </center>
        <%
            if (index == 0) {
        ...
        <div class="checkout-left">
            <div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
                <a href="index.jsp"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Вернуться
                к покупкам</a>
            </div>
        </div>
    </div>
