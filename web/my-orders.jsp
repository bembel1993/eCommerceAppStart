...
<div class="page-head">
    <div class="container">
        <h3><font color="#4169e1">Мои заказы</font></h3>
    </div>
</div>
...
<div class="table-responsive">
    <table class="table table-bordered" width="300px">
        ...
        <tr class="rem1">
            ...
            %>
            <td><span class="label label-success"><strong>Доставлен</strong></span></td>
            <%
            } else {
            %>
            <td><span class="label label-danger"><strong>В ожидании</strong></span></td>
            <%
                }
            %>
        </tr>
